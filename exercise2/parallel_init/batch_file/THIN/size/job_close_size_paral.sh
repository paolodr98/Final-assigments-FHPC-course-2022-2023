...
output_dir="/u/dssc/pdarol00/Final-assigments-FHPC-course-2022-2023/exercise2/parallel_init/batch_file/THIN/size/output_close_size_paral"
...
do
    ...
    do
        ...
        do
            ...
            do
                srun -n1 --cpus-per-task=12 $make_dir/gemm_"$implem"_"$type".x $m_size $m_size $m_size > output_close.txt #just a temporary file
